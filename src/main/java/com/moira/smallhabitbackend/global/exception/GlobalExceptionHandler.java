...
import com.moira.smallhabitbackend.global.exception.custom.HabitBookException;
...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(value = HabitBookException.class)
    public ResponseEntity<ErrorResponse> handleHabitBookException(HabitBookException e) {
        ErrorResponse errorResponse = ErrorResponse.builder()
                .message(e.getMessage())
                .errorCode(e.getErrorCode())
                .status(e.getHttpStatus())
